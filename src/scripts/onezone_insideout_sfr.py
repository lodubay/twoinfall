...
from multizone.src.models import fiducial_sf_law
from track_and_mdf import setup_figure, plot_vice_onezone
from apogee_sample import APOGEESample
import paths
from utils import get_bin_centers, insideout_onezone
...
def main():
    ...
    sfr = insideout_onezone(RADIUS, dr=ZONE_WIDTH)
    ...
    sz.tau_star = fiducial_sf_law(area)
    # sz.RIa = exponential()
    ...
    plt.savefig(paths.figures / "onezone_insideout_sfr")
    plt.close()
