...
def main(style='poster', cmap='Spectral_r'):
    ...
    axs[0,1].contour(xx, yy, scaled_density, levels, colors='k',
    ...
    axs[0,1].plot(hist['[fe/h]'], hist['[o/fe]'], color='k', marker='none', linewidth=2)
    ...
    axs[1,1].hist(mzs_lmr('age'), bins=hist_age_bins, weights=mzs_lmr('mstar'), 
                density=True, 
    ...
    local_sample.plot_kde2D_contours(axs[0,0], 'FE_H', 'O_FE',
                                    c='k', lw=0.5, ls='-', 
