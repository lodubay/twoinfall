...
\begin{deluxetable*}{lCCCcDDD}
    ...
    \decimals
    \startdata
        {\tt yZ1-fiducial}  & 1 & 0.2   & 4.2 & Equation \ref{eq:plateau-dtd}  & 2.68  & 0.12  & $-\infty$   \\
        {\tt yZ1-migration} & 1 & 0.2   & 4.2 & Equation \ref{eq:plateau-dtd}  & 5.0   & 0.12  & $-\infty$   \\
        {\tt yZ1-diskratio} & 1 & 0.2   & 4.2 & Equation \ref{eq:plateau-dtd}  & 2.68  & 0.5   & $-\infty$   \\
        {\tt yZ1-preenrich} & 1 & 0.6   & 4.2 & Equation \ref{eq:plateau-dtd}  & 2.68  & 0.12  & -0.5      \\
        {\tt yZ1-best}      & 1 & 0.4   & 4.2 & Equation \ref{eq:plateau-dtd}  & 3.6   & 0.25  & -0.7      \\
        \hline
        {\tt yZ2-fiducial}  & 2 & 1.4   & 4.2 & Equation \ref{eq:plateau-dtd}  & 2.68  & 0.12  & $-\infty$   \\
        {\tt yZ2-earlyonset}& 2 & 1.4   & 3.2 & Equation \ref{eq:plateau-dtd}  & 2.68  & 0.12  & $-\infty$   \\
        {\tt yZ2-powerlaw}  & 2 & 1.4   & 4.2 & Equation \ref{eq:powerlaw-dtd} & 2.68  & 0.12  & $-\infty$   \\
        {\tt yZ2-diskratio} & 2 & 1.4   & 4.2 & Equation \ref{eq:plateau-dtd}  & 2.68  & 0.5   & $-\infty$   \\
        {\tt yZ2-preenrich} & 2 & 2.4   & 4.2 & Equation \ref{eq:plateau-dtd}  & 2.68  & 0.12  & -0.5      \\
        {\tt yZ2-best}      & 2 & 1.8   & 3.2 & Equation \ref{eq:plateau-dtd}  & 3.6   & 0.25  & -0.7      \\
        \hline
