...
\begin{figure}
    ...
    \added{The 2-D histograms show the APOGEE stellar age--abundance distributions in the Solar neighborhood ($7\leq R_{\rm gal}<9\kpc$, $|z|<0.5\kpc$), adopting the \citet{leung_variational_2023} ages. The black points plot the mode of the abundance data in 1 Gyr-wide age bins, and the gray error bars along the bottom of each panel indicate the median age and abundance errors as a function of age.}
...
Figure \ref{fig:yield-outflow} shows the mode of the APOGEE [O/H], [Fe/H], and [O/Fe] distributions as a function of age at the Solar annulus, using the NN ages from \citet{leung_variational_2023}. As shown by \citet{johnson_milky_2025}, the peak of the MDF is less susceptible to modification by radial migration, making it a more reliable proxy for ISM chemistry at a given lookback time than the mean or median.
...
\todo{Contrast with: multiple sequences in Anders et al. (2023), Xiang \& Rix (2022), Sahlholdt et al. (2022).}
