...
The figures, tables, and models in this paper are reproducible. The git repository associated to this study is publicly available at \url{\GitHubURL}, and the release \todo{v1.X.X} allows anyone to re-build the entire manuscript. The multi-zone model outputs and APOGEE sample dataset are stored at \todo{Zenodo URL}, and the source code for this manuscript is stored at \todo{Zenodo URL}.
