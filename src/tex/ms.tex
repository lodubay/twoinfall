...
With this relationship, we estimate ages for \num{113449} stars across the disk, including \num{20992} in the Solar neighborhood.
...
The figures, tables, and models in this paper are reproducible. The git repository associated to this study is publicly available at \url{\GitHubURL}, and the release {\tt v1.0.0} allows anyone to re-build the entire manuscript. The multi-zone model outputs are stored at \url{https://doi.org/10.5281/zenodo.16649938}, and the source code for this manuscript is stored at \todo{Zenodo URL}.
