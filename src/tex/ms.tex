...
\begin{deluxetable*}{Ccccl}
    ...
    \tablehead{
        \colhead{Quantity} & \colhead{Fiducial Value(s)} & \colhead{Alternatives} & \colhead{Section} & \colhead{Description}
    }
    \startdata
