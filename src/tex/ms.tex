...
\begin{figure*}
    ...
    \caption{The model parameters are fixed at $\tau_1=1$ Gyr, $\tau_2=15$ Gyr, and $\tau_{\rm on}=3.2$ Gyr. Key takeaway: the size of the thin disk loop can be reduced by using an SN Ia DTD with more prompt events. However, this messes up the location of the high-alpha sequence.}
    \label{fig:dtd}
\end{figure*}
...
\begin{figure*}
    ...
    \caption{Illustration of the effect of changing the infall history parameters on one-zone gas-phase abundances.}
...
\begin{figure}
    ...
    \caption{Key takeaway: the higher yields produce slower recent evolution of [O/H] and [Fe/H], but a greater rise in [O/Fe] after the second infall. In contrast, the lower yields lead to a more rapid evolution of [O/H] and [Fe/H], but a much smaller rise in [O/Fe].}
