...
\begin{abstract}
    % The Milky Way's stellar disk can be separated into multiple chemically and kinematically distinct components. 
    The two-infall model has long been proposed to explain the formation of the Milky Way's thick and thin disks through two consecutive gas accretion epochs. It has successfully reproduced observed abundance patterns in the Solar neighborhood and across the disk. However, few studies have explored a two-infall with significant mass-loaded outflows
\end{abstract}
